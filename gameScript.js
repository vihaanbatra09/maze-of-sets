  ...
  return positions;
    ...
    function spawnDoor() {
      ...
      doorMesh = new THREE.Mesh(
        new THREE.BoxGeometry(TILE_SIZE * 0.8, TILE_SIZE * 1.2, WALL_THICKNESS),
        new THREE.MeshStandardMaterial({ color: 0x8d5524, metalness: 0.2, roughness: 0.7 })
      );
    ...
    const levelQuestions = [
      // Level 1: Your questions and table
      [
        {
